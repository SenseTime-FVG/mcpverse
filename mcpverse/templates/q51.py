...
question = "Compared to the previous closing day, did the last closing price leave me overall up or down if I own one share each of GOOGL and TSLA?"
...
def get_reference():
    ...
    total_last_value = last_value_1 + last_value_2
    total_previous_value = previous_value_1 + previous_value_2
