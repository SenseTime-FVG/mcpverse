...
question = "Could you please tell me the scheduled departure time, arrival time, and flight number of the earliest flight from Shenzhen Bao'an Airport to Wuhan Tianhe International Airport tomorrow?"
...
def get_reference():
    ...
    reference = f"Tomorrow, the earliest flight from Shenzhen Bao'an Airport to Wuhan Tianhe International Airport is flight {flight_no}, scheduled to depart at {deptime} and arrive at {arrtime}."
    return reference
