...
question = "What is the tasks included in He Kaiming's latest paper according to the information on Paper with Code?"
def get_reference():
    ...
    if not tasks:
        return f"No tasks found for the latest paper {title_1} by He Kaiming."
    else:
        return f"The tasks included in He Kaiming's latest paper '{title_1}' are: {', '.join(tasks)}."
